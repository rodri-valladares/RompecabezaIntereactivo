...
function mostrarCartelGanador() {
    ...
    img.id="cartel-ganador";
    img.src="images/trofeo.gifs";
    div.appendChild(img);

    var textoGanador=document.createElement('p');
    textoGanador.textContent="  ¡ Buena jugada ! "+"                   movimientos: "+movimientos.length;
    
    div.appendChild(textoGanador);
...
function moverEnDireccion(direccion) {
  ...
  if(primeraVuelta){  /*validacion para evitar que al mezclar las piezas me mueva la flecha*/ /*MIO*/
...
function mezclarPiezas(veces) {
  if (veces <= 0) {
    primeraVuelta=true;/*creo una bandera para marcar que termino de mezclar piezas*//*MIO*/
    return;
  }
